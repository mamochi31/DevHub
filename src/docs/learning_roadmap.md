...
### Phase 3: バックエンド連携 (Spring Boot) (完了 ✅)

- [x] **REST API 構築**: 記事 (Post) に対する CRUD (作成・読み取り・更新・削除) 機能の実装。

- [x] **CORS 対策**: フロントエンド (Vite) とバックエンドの接続設定。

- [x] **認証機能**: JWT (JSON Web Token) 等を用いたログイン機能の実装。

### Phase 4: インフラ & デプロイ (AWS) (Next Step 🚀)
